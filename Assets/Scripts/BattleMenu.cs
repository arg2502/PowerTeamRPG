...
////        {
////            List<DenigenData> tempHeroes = GameControl.control.heroList;
////            GameObject temp;
...
////                denigenArray[i].hpChange = tempHeroes[i].hp;
////                denigenArray[i].hpMaxChange = tempHeroes[i].hpMax;
////                denigenArray[i].pmChange = tempHeroes[i].pm;
////                denigenArray[i].pmMaxChange = tempHeroes[i].pmMax;
////                denigenArray[i].atkChange = tempHeroes[i].atk;
////                denigenArray[i].Atk = tempHeroes[i].atk;
////                denigenArray[i].defChange = tempHeroes[i].def;
////                denigenArray[i].Def = tempHeroes[i].def;
////                denigenArray[i].mgkAtkChange = tempHeroes[i].mgkAtk;
////                denigenArray[i].MgkAtk = tempHeroes[i].mgkAtk;
////                denigenArray[i].mgkDefChange = tempHeroes[i].mgkDef;
////                denigenArray[i].MgkDef = tempHeroes[i].mgkDef;
////                denigenArray[i].luckChange = tempHeroes[i].luck;
////                denigenArray[i].Luck = tempHeroes[i].luck;
////                denigenArray[i].evasionChange = tempHeroes[i].evasion;
////                denigenArray[i].Evasion = tempHeroes[i].evasion;
////                denigenArray[i].spdChange = tempHeroes[i].spd;
...
////            heroList[i].Card.GetComponent<TextMesh>().text = heroList[i].name + "\nLvl: " + heroList[i].Level + "\nHP: " + heroList[i].hpChange + " / " + heroList[i].hpMaxChange
////                + "\nPM: " + heroList[i].pmChange + " / " + heroList[i].pmMaxChange;
...
////            enemyList[i].Card.GetComponent<TextMesh>().text = enemyList[i].name + "\nLvl: " + enemyList[i].Level + "\nHP: " + enemyList[i].hpChange + " / " + enemyList[i].hpMaxChange
////                + "\nPM: " + enemyList[i].pmChange + " / " + enemyList[i].pmMaxChange;
...
////            {
////                if (denigenArray[i].spdChange < denigenArray[i + 1].spdChange)
////                {
...
////    {
////        d.Card.GetComponent<TextMesh>().text = d.name + "\nLvl: " + d.Level + "\nHP: " + d.hpChange + " / " + d.hpMaxChange
////                + "\nPM: " + d.pmChange + " / " + d.pmMaxChange;
...
////                            && currentDenigen.pmChange < currentDenigen.SkillsList[j].Pm)
////                        {
...
////                            && currentDenigen.pmChange < currentDenigen.SpellsList[j].Pm)
////                        {
////                            if (i == 0) { buttonArray[i].GetComponent<MyButton>().state = MyButton.MyButtonTextureState.inactiveHover; }
////                            else { buttonArray[i].GetComponent<MyButton>().state = MyButton.MyButtonTextureState.inactive; }
////                        }
...
////                    h.hp = h.hpMax;
////                    h.pm = h.pmMax;
////                    h.statusState = DenigenData.Status.normal;
////                }
...
////                            hd.hp = h.hpChange;
////                            hd.hpMax = h.hpMaxChange;
////                            hd.pm = h.pmChange;
////                            hd.pmMax = h.pmMaxChange;
////                            hd.atk = h.Atk;
////                            hd.def = h.Def;
////                            hd.mgkAtk = h.MgkAtk;
////                            hd.mgkDef = h.MgkDef;
...
////                            hd.luck = h.Luck;
////                            hd.spd = h.Spd;
////                            hd.statusState = (DenigenData.Status)h.StatusState;
