...
public class MovableOverworldObject : OverworldObject {
    ...
    public bool CheckCollisions(Vector3 dir)
    {
        ...
        //Debug.DrawRay(new Vector3(transform.position.x + collisionOffset, transform.position.y, transform.position.z), dir, Color.red);
        //Debug.DrawRay(new Vector3(transform.position.x - collisionOffset, transform.position.y, transform.position.z), dir, Color.red);
        //Debug.DrawRay(new Vector3(transform.position.x, transform.position.y - collisionOffset - 8.0f, transform.position.z), dir, Color.red);
        //Debug.DrawRay(new Vector3(transform.position.x, transform.position.y + collisionOffset, transform.position.z), dir, Color.red);

        //Debug.DrawRay(new Vector3(transform.position.x + collisionOffset, transform.position.y + collisionOffset, transform.position.z), dir, Color.white);
        //Debug.DrawRay(new Vector3(transform.position.x - collisionOffset, transform.position.y - collisionOffset, transform.position.z), dir, Color.white);
        //Debug.DrawRay(new Vector3(transform.position.x + collisionOffset, transform.position.y - collisionOffset, transform.position.z), dir, Color.white);
        //Debug.DrawRay(new Vector3(transform.position.x - collisionOffset, transform.position.y + collisionOffset, transform.position.z), dir, Color.white);
